...
public class Query {
	public static void main(String[] args) throws Exception {
		...
		DataSet<SolutionMapping> sm1 = dataset
			.filter(new T2T_FF(null, "http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/vocabulary/product", "http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/dataFromProducer1/Product15"))
